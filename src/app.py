...
<head>
    ...
    <style>
        ...
        header { background-color: #1f1f1f; padding: 20px; text-align: center; font-size: 1.8em; font-weight: bold; color: #00bcd4; }
        main { padding: 40px; text-align: center; }
        .card { background-color: #1e1e1e; border-radius: 8px; padding: 20px; display: inline-block; box-shadow: 0 4px 8px rgba(0,0,0,0.5); }
        .btn { background-color: #00bcd4; color: #121212; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; font-weight: bold; margin-top: 20px; }
